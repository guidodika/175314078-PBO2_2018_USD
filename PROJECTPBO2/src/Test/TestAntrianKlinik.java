...
public class TestAntrianKlinik {
    public static void main(String[] args) {
        ...
        System.out.println(AntrianKlinik.daftarAntrian.get(indeksAntrian).getKlinik().getIdKlinik()+" "+
                AntrianKlinik.daftarAntrian.get(indeksAntrian).getKlinik().getNamaKlinik());
